    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="#" onclick="addAdmin('{{ route('operator.store') }}')" class="btn btn-primary btn-icon-split float-right">
...
@includeIf('form.pengaturan.operator')
@endsection
...
@push('scripits')
    ...
    <script>
        ...
        function addAdmin(url){
            ...
            $('#modalAdmin .modal-title').text('Tambah User Operator');
        ...
        function editAdmin(url, id){
            $('#modalAdmin').modal('show');
            $('#modalAdmin .modal-title').text('Ubah User Operator');
            ...
            let show = "{{route('operator.show', '')}}"+"/"+id;
            $.get(show)
            .done((response) => {
