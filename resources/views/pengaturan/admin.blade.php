    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="#" onclick="addAdmin('{{ route('admin.store') }}')" class="btn btn-primary btn-icon-split float-right">
...
@includeIf('form.pengaturan.admin')
@endsection
...
@push('scripits')
    ...
    <script>
        ...
        function editAdmin(url, id){
            $('#modalAdmin').modal('show');
            $('#modalAdmin .modal-title').text('Ubah instansi');
