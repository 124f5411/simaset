    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Data Admin Aset</h6>
                <a href="#" onclick="addAdmin('{{ route('adminaset.store') }}')" class="btn btn-primary btn-icon-split float-right">
...
@includeIf('form.pengaturan.adminaset')
@endsection
...
@push('scripits')
    ...
    <script>
        ...
        function addAdmin(url){
            ...
            $('#modalAdmin .modal-title').text('Tambah Admin Aset');
        ...
        function editAdmin(url, id){
            $('#modalAdmin').modal('show');
            $('#modalAdmin .modal-title').text('Ubah Admin Aset');
            ...
            let show = "{{route('adminaset.show', '')}}"+"/"+id;
            $.get(show)
            .done((response) => {
