<div class="modal fade" id="modalKibF"  aria-labelledby="modalKibFLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form class="form-kibC" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalKibFLabel">Modal title</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="t_mulai" name="t_mulai">
                            </div>
                            <div class="form-group">
